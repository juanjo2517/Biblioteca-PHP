    ...
    <div class="full-box dashboard-sideBar-ct">
        ...
        <div class="full-box dashboard-sideBar-UserInfo">
            <figure class="full-box">
                <img src="<?php echo SERVERURL; ?>views/assets/avatars/<?php echo $_SESSION['foto_BP']?>" alt="UserIcon">
                <figcaption class="text-center text-titles"><?php echo $_SESSION['nombre']." ".$_SESSION['apellido'];?></figcaption>
            </figure>
            <ul class="full-box list-unstyled text-center">
                ...
                <li>
                    <a href="<?php echo $loginObj->encryption($_SESSION['token_BP']);?>" title="Salir del sistema" class="btn-exit-system">
