...
<div class="container-fluid">
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <form action="<?php echo SERVERURL ?>ajax/AdminAjax.php" method="POST" data-form="save" class="FormularioAjax" enctype="multipart/form-data">
            <fieldset>
				    		...
				    		<div class="container-fluid">
				    			<div class="row">
									...
									<?php if($_SESSION['privilegio_BP']==1): ?>
										<div class="radio radio-primary">
											<label>
												<input type="radio" name="optionsPrivilegio" id="optionsRadios1" value="<?php echo $loginObj->encryption(1)?>">
									...
									<?php  if($_SESSION['privilegio_BP']<=2): ?>
										<div class="radio radio-primary">
											<label>
												<input type="radio" name="optionsPrivilegio" id="optionsRadios2" value="<?php echo $loginObj->encryption(2)?>">
									...
									<?php endif;?>
										<div class="radio radio-primary">
											<label>
												<input type="radio" name="optionsPrivilegio" id="optionsRadios3" value="<?php echo $loginObj->encryption(3)?>" checked="">
